...
public class ViewVC1_0InterfaceTest extends AbstractTestCase {
    ...
    private ViewVC1_0Interface _interface;
     ...
     * @param testName
     */
    public ViewVC1_0InterfaceTest(String testName) {
        super(testName);
    }
    ...
    protected void setUp() throws Exception {
        ...
        _interface = new ViewVC1_0Interface(_grabber);
        _interface.setRoot("cvsgrab");
    }

    public void testDetect() throws Exception {
        Document doc = getDocument("src/test/html_docs/view_vc_1_0.html");
    ...
    public void testGetFiles() throws Exception {
        Document doc = getDocument("src/test/html_docs/view_vc_1_0_cvsgrab.html");
